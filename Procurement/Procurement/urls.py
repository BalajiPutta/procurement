...
from procurement_app import views
...
urlpatterns = [
    ...
    path('user_raisehome/', TemplateView.as_view(template_name='user_raisehome.html'), name='user_raisehome'),
    path('user_raise_req/', TemplateView.as_view(template_name='user_raise_req.html'), name='user_raise_req'),
    path('user_raisehome/', user_raisehome, name='user_raise_req'),

    #path('validate/',views.validate()),
    path('user_cancelhome/', TemplateView.as_view(template_name='user_cancelhome.html'), name='user_cancelhome'),
    path('user_cancel_req/', TemplateView.as_view(template_name='user_cancel_request.html'), name='user_cancel_request'),
    path('user_cancel_req/', user_cancel_req, name='user_cancel_req'),
